...
class LogFeatures(models.Model):
    ...
    GENRE_CHOICES_3 = BLANK_CHOICE_DASH+[('Radio_TV_Hifi','Radio_TV_Hifi'),
                                         ('Furniture_Carpet','Furniture_Carpet'), ('Dept_Store_Mail','Dept_Store_Mail'),
                                         ('Leisure','Leisure'),('Cars','Cars'), ('OT','OT')]
    GENRE_CHOICES_4 = BLANK_CHOICE_DASH+[('Lease','Lease'),('Owner','Owner')]
    GENRE_CHOICES_5 = BLANK_CHOICE_DASH+[('German','German'), ('Turkish','Turkish'),
                                         ('RS','RS'), ('Greek','Greek'),('Yugoslav','Yugoslav'), ('Italian','Italian'),
                                        ('Other_European','Other_European'), ('Spanish_Portugue','Spanish_Portugue')]
    GENRE_CHOICES_6 = BLANK_CHOICE_DASH+[('Others','Others'),('Civil_Service_M','Civil_Service_M'),
                                         ('Self_employed_pe','Self_employed_pe'), ('Food_Building_Ca','Food_Building_Ca'),
                                         ('Chemical_Industr','Chemical_Industr'), ('Pensioner','Pensioner'),
                                         ('Sea_Vojage_Gast','Sea_Vojage_Gast'), ('State_Steel_Ind,','State_Steel_Ind,'),
                                         ('Military_Service','Military_Service')]
    GENRE_CHOICES_7 = BLANK_CHOICE_DASH+[('Car','Car'), ('Without_Vehicle','Without_Vehicle'),
                                         ('Car_and_Motor_bi','Car_and_Motor_bi')]
    GENRE_CHOICES_8 = BLANK_CHOICE_DASH+[('Cheque_card','Cheque_card'), ('no_credit_cards','no_credit_cards'), 
                                         ('Mastercard_Euroc','Mastercard_Euroc'), ('VISA_mybank','VISA_mybank'),
                                         ('VISA_Others','VISA_Others'), ('Other_credit_car','Other_credit_car'),
